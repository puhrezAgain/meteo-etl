...
def fetch(long: float = typer.Option(None, help="Longitude of location to fetch"),
          ...
          source: SourceName = typer.Option(SourceName.METEO, help="API to be used in fetching", case_sensitive=False),
          params: list[str] = typer.Option([], "-p", "--param", help="Repeated able <key>=<value> pairs to pass to the Source API call")):
    """
